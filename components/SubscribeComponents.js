            ...
            <div className="container mx-auto px-5 lg:px-28  ">
                <div className="items-center justify-center flex flex-col text-center">
                    <div data-aos="fade-up" data-aos-duration="2000" className="mt-8 lg:mt-20 mb-12 lg:mb-28">
                        <h2 className="text-[31px] lg:text-[36px]  font-bold text-center head_text_main">Ready to get started?</h2>
                        <p className="text-[18px] font-medium text-center mb-5 mt-3 sub_head_text_main">Up 4 Change will be live soon but we&apos;d love you to connect and stay in the loop to start making change NOW!</p>
                        <div>
