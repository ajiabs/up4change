...
const [navSize, setnavSize] = useState("110px");
  ...
  const listenScrollEvent = () => {
    ...
    window.scrollY > 10 ? setnavSize("110px") : setnavSize("110px");
  };
  useEffect(() => {
      ...
      class="px-3 lg:px-40 py-5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0">
        <div class="bg-[#f9cc6a] lg:bg-transparent container flex flex-wrap items-center justify-start mx-auto">
          ...
          <div class="flex md:order-2 ml-auto">
            ...
            <button data-collapse-toggle="navbar-sticky" type="button" class="inline-flex items-center p-2 text-sm text-black rounded-lg md:hidden " aria-controls="navbar-sticky" aria-expanded="false">
