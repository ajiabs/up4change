  ...
  return (
    <div className='bg-[#f9cc69] md:bg-[#f9cc69] lg:bg-[#24202d]'>
      ...
      <div className="flex relative">
        ...
        <div className="w-2/3 bg-none md:bg-none banner_bg_main bg-no-repeat bg-cover
          ...
          <h3 data-aos="fade-down" data-aos-duration="2000" className='head_text_main font-bold text-[32px] lg:text-[42px]  lg:text-left mt-[15px] leading-[42px] lg:leading-[55px]'>G’day Changemaker,<br></br> ready to shake up the world?</h3>
          <p data-aos="fade-up" data-aos-duration="2000" className='sub_head_text_main text-[20px] font-semibold  lg:text-left leading-8 mt-[15px]'>Transforming pocket change into big change.<br></br>
