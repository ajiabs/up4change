...
function AppFeaturesComponents() {
    return (
        <div className="orange_bg pb-10 lg:pb-16 pt-10 lg:pt-16">
            <div className="container mx-auto px-4 lg:px-28  ">
                <div className="items-center justify-center flex flex-col text-center">
                    <div className='relative'>
                    <h2 data-aos="fade-up" data-aos-duration="2000" className="text-[32px] lg:text-[48px]  font-bold text-center head_text_main mb-12">App features</h2>
                    <div className='w-[100px] h-[3px] under_line_bg absolute top-[55px] left-[22%] sm:top-[55px] sm:left-[22%] md:top-[110px] md:left-[35%] lg:top-[88px] lg:left-[32%]'></div>
                    </div>
                    ...
                    <div className="flex w-full flex-wrap">
                        ...
                        <div data-aos="fade-down" data-aos-duration="2000" className="w-full lg:w-1/3 pr-0 lg:pr-8">
                            <div>
                                ...
                                <h3 className='head_text_main font-bold text-[22px] text-center lg:text-right mt-[15px]'>Fiind charities that match your values</h3>
                                <p className='sub_head_text_main text-[18px] font-semibold text-center lg:text-right leading-7 mt-[15px]'>Capture your interests and values during onboarding, tailoring the charities
                            ...
                            <div>
                                ...
                                <h3 className='head_text_main font-bold text-[22px] text-center lg:text-right mt-[15px]'>Discover the great work being done</h3>
                                <p className='sub_head_text_main text-[18px] font-semibold text-center lg:text-right leading-7 mt-[15px]'>Learn about new organisations and see your 
                        ...
                        <div>
                                ...
                                <h3 className='head_text_main font-bold text-[22px] text-center lg:text-left mt-[15px]'>Automate your giving</h3>
                                <p className='sub_head_text_main text-[18px] font-semibold text-center lg:text-left leading-7 mt-[15px]'>Link your debit card to the platform and 
                            ...
                            <div>
                                ...
                                <h3 className='head_text_main font-bold text-[22px] text-center lg:text-left mt-[15px]'>Work together with others</h3>
                                <p className='sub_head_text_main text-[18px] font-semibold text-center lg:text-left leading-7 mt-[15px]'>Join a group of people all working together 
