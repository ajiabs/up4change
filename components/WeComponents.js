        ...
        <div className="bg-[#24202d]">
            <div className="container mx-auto px-4 lg:px-48">
                ...
                <div className="mt-10 lg:mt-44 mb-10 lg:mb-52">
                        <h2 className="text-[32px] lg:text-[48px]  font-bold text-center  text-white">We &#10084; generous people</h2>
                        <p className="text-[18px] lg:text-[24px] font-semobold text-center mb-5 mt-3 text-white">Up 4 Change is a 
