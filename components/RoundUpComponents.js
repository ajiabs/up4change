...
function RoundUpComponents() {
    return (
        <div className="bg-[#fc8965] pb-10 lg:pb-16 pt-4 lg:pt-16 relative">
                       ...
                       <div className="flex flex-col-reverse lg:flex-row w-full pb-0 lg:pb-36 flex-wrap ">
                        ...
                        <div data-aos="fade-up"  data-aos-duration="2000" className="w-full lg:w-1/2 pr-8">
                            <div className='relative'>
                                ...
                                <p className='text-[#161f3d] text-[14px] lg:text-[18px] font-semibold text-left leading-[25px] lg:leading-[36px] mt-[15px]'>Connect with causes
                    ...
                    <div className="flex w-full pb-0 lg:pb-36 flex-wrap">
                        ...
                        <div data-aos="fade-down" data-aos-duration="2000" className="w-full lg:w-1/2 pr-8">
                            ...
                            <h1 className='text-[200px] absolute font-semibold  text-white opacity-25 right-[0px] top-[-138px]'>2</h1>
                                ...
                                <p className='text-[#161f3d] text-[14px] lg:text-[18px] font-semibold text-left lg:text-right leading-[25px] lg:leading-[36px] mt-[15px]'>Select round up limits for each 
                    ...
                    <div className="flex w-full pb-0 lg:pb-36 flex-wrap flex-col-reverse lg:flex-row">
                        ...
                        <div className='relative'>
                            <h1 className='text-[200px] absolute font-semibold  text-white opacity-25 top-[-138px]'>3</h1>
                                ...
                                <p className='text-[#161f3d]text-[14px] lg:text-[18px] font-semibold text-left leading-[25px] lg:leading-[36px] mt-[15px]'>Up 4 Change seamlessly rounds up your transactions in the background to the 
                    ...
                    <div className="flex w-full pb-0 lg:pb-36 flex-wrap">
                        ...
                        <div className='relative'>
                            <h1 className='text-[200px] absolute font-semibold  text-white opacity-25 right-[0px] top-[-138px]'>4</h1>
                                ...
                                <p className='text-[#161f3d] text-[14px] lg:text-[18px] font-semibold text-left lg:text-right leading-[25px] lg:leading-[36px] mt-[15px]'>Have the choice to direct your<br></br>
